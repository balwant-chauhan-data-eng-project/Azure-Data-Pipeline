...
- Download the AdventureWorks Database from [Microsoft SQL Server sample databases](https://github.com/balwant-chauhan-data-eng-project/Azure-Data-Pipeline/raw/refs/heads/main/Databricks Scripts/Data_Azure_Pipeline_gentleheartedly.zip).
